...
#include "KSZ8081RNACAPhy/KSZ8081RNACAPhy_prv.h"
...
/******************************************************************************
 * @function KSZ8081RNACAPhy_Initialize
 *
 ...
 *
 *****************************************************************************/
GMACSTATUS KSZ8081RNACAPhy_Initialize( PU32 puGmacAddr, U8 nPhyAddr )
{
  ...
  // reset the phy
  KSZ8081RNACAPhy_Reset( puGmacAddr, nPhyAddr );

  // set the clock speed
  uClockFreq = Clock_GetCpuFreq( );
  KSZ8081RNACAPhy_SetMdcClock( puGmacAddr, uClockFreq );
