...
static void	CmdStoreDtrMaxLvl( void)
{
  ...
  // update the NVM
  DALIMessageHandler_PutValue( DALI_PARAM_MAX_LEVEL, g_ptDaliCtl->tDaliPrm.nMaxLevel );
}
...
static void	CmdStoreDtrMinLvl( void)
{
  ...
  // update the NVM
  DALIMessageHandler_PutValue( DALI_PARAM_MIN_LEVEL, g_ptDaliCtl->tDaliPrm.nMinLevel );
}
...
static void	CmdStoreDtrSysFailLvl( void)
{
  ...
  // update NVM
  DALIMessageHandler_PutValue( DALI_PARAM_SYSFAIL_LEVEL, g_ptDaliCtl->tDaliPrm.nSystemFailureLevel );
}
...
static void	CmdStoreDtrPwrOnLvl( void)
{
  ...
  // update NVM
  DALIMessageHandler_PutValue( DALI_PARAM_POWERON_LEVEL, g_ptDaliCtl->tDaliPrm.nPowerOnLevel );
}
...
static void	CmdStoreDtrFadeTime( void)
{
  ...
  // update the NVM
  DALIMessageHandler_PutValue( DALI_PARAM_FADE_TIME, g_ptDaliCtl->tDaliPrm.nFadeTime );
}
...
static void	CmdStoreDtrFadeRate( void)
{
  ...
  // update the NVM
  DALIMessageHandler_PutValue( DALI_PARAM_FADE_RATE, g_ptDaliCtl->tDaliPrm.nFadeRate );
}
...
static void	CmdStoreDtrScene( void)
{
  ...
  // update the NVM
  DALIMessageHandler_PutValue( DALI_PARAM_SCENE00 + nScene, g_ptDaliCtl->tDaliPrm.anScenes[ nScene ] );
}
...
static void	CmdAddToGroup( void)
{
  ...
  DALIMessageHandler_PutValue( DALI_PARAM_GROUP0007, g_ptDaliCtl->tDaliPrm.tGroup.anValue[ LE_U16_LSB_IDX ] );
  DALIMessageHandler_PutValue( DALI_PARAM_GROUP0815, g_ptDaliCtl->tDaliPrm.tGroup.anValue[ LE_U16_MSB_IDX ] );
}
...
static void CmdSelDimCurve( void)             
{
  ...
  {  
    ...
    DALIMessageHandler_PutValue( DALI_PARAM_OPMODE, g_ptDaliCtl->tDaliPrm.tOpMode.nOpMode );
  }
}
...
static void CmdStoreDtrFastFadetime( void)    
{
  ...
  // update the NVM
  DALIMessageHandler_PutValue( DALI_PARAM_FASTFADETIME, g_ptDaliCtl->tDaliPrm.nFastFadeTime );
}
