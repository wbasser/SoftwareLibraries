...
typedef struct PACKED _DALICTL
{
  ...
  struct
  {
    ...
    BOOL  bDimmingCurveEnable       : 1;  ///< dimming curve enable
...
typedef void  ( *PVCMDHANDLERFUNC )( PDALICTL );
...
/// fade rates in ( steps/ms ) * 1000
static  const CODE U16 awFadeRates[ MAX_NUM_NORMFADERATES ] =
{
     0, 3580, 2530, 1790, 1270, 894, 633,  447,
   316,  224,  158,  112,   79,  56,  40,  28
};
