...
// local includes -------------------------------------------------------------
#include "VaricodeTable/VaricodeTable.h"
...
static  const CODE U16  awVericodeTable[ TABLE_MAX_SIZE ] =
{
...
/******************************************************************************
 * @function VeriCodeTable_CodeToAscii
 *
 * @brief translate vericode to ascii
 *
 * This function will translate an vericode code to ascii 
 *
 * @param[in]   wCode     vericode
 *
 * @return      ascii code
 *
 *****************************************************************************/
U8 VeriCodeTable_CodeToAscii( U16 wCode )
{
  U16  wIndex = 0;

  // for each entry in the table
  for ( wIndex = 0; wIndex < TABLE_MAX_SIZE; wIndex++ )
  {
    /// code found
    if ( awVericodeTable[ wIndex ] == wCode )
    {
      // code found - break;
      break;
    }
...
/******************************************************************************
 * @function VericodeTable_AsciiToCode
 *
 * @brief translate ascii to vericode
 *
 * This function will translate an ascii code to a vericode
 *
 ...
 *
 *****************************************************************************/
U16 VericodeTable_AsciiToCode( U8 nCode )
{
  // just return the code at the index
  return( awVericodeTable[ nCode ] );
}
