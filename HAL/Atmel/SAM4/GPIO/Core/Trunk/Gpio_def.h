...
#define GPIOFNCDEF( port, pin, mode, func ) \
  { \
    .ePort          = port, \
    .nPin           = pin, \
    .eMode          = mode, \
...
typedef enum _GPIOMODE
{
  ...
  GPIO_MODE_FNC_NORMAL,     ///< function, normal
  GPIO_MODE_FNC_PULLDN,     ///< function, pull down
  GPIO_MODE_FNC_PULLUP,     ///< function, pull up
  GPIO_MODE_FNC_PULLUPDN,   ///< function, pull up/down
  GPIO_MODE_FNC_DEFAULT,    ///< function, default
  GPIO_MODE_MAX
} GPIOMODE;
