...
// local includes -------------------------------------------------------------
#include "AtmelSAM4LwipHandler/AtmelSAM4LwipHandler.h"
#include "AtmelSAM4LwipHandler/AtmelSAM4LwipHandler_prm.h"
...
/******************************************************************************
 * @function AtmelSAM4LwipHandler_Initialize
 *
 ...
 *
 *****************************************************************************/
void AtmelSAM4LwipHandler_Initialize( void )
{
}

/******************************************************************************
 * @function AtmelSAM4LwipHandler_GetConfigDflt
 *
 ...
 *
 *****************************************************************************/
PLWIPCFGDEF AtmelSAM4LwipHandler_GetConfigDflt( void )
{
...
/******************************************************************************
 * @function AtmelSAM4LwipHandler_GetConfigActl
 *
 ...
 *
 *****************************************************************************/
PLWIPCFGDEF AtmelSAM4LwipHandler_GetConfigActl( void )
{
...
/******************************************************************************
 * @function AtmelSAM4LwipHandler_Congifure
 *
 * @brief stellaris LWIP handler initialization
 *
 * This function initializes the stellaris LWIP implementation.  It will also
 ...
 *
 *****************************************************************************/
void AtmelSAM4LwipHandler_Configure( void )
{
...
/******************************************************************************
 * @function AtmelSAM4LwipHandler_SetConfig
 *
 ...
 *
 *****************************************************************************/
LWIPERRORS AtmelSAM4LwipHandler_SetConfig( PLWIPCFGDEF ptLwipCfgDef )
{
...
/******************************************************************************
 * @function AtmelSAM4LwipHandler_GetCurrentNetConfig
 *
 ...
 *
 *****************************************************************************/
void AtmelSAM4LwipHandler_GetCurrentNetConfig( PLWIPCFGDEF ptConfig )
{
...
/******************************************************************************
 * @function AtmelSAM4LwipHandler_GetMacAddr
 *
 ...
 *
 *****************************************************************************/
void AtmelSAM4LwipHandler_GetMacAddr( PU8 pnMacAddress )
{
  // return the mac address
}

/******************************************************************************
 * @function AtmelSAM4LwipHandler_ProcessTimer
 *
 ...
 *
 *****************************************************************************/
BOOL AtmelSAM4LwipHandler_ProcessTimer( TASKARG arg )
{
  PLWIPPROTDEF  ptDef;
  LWIPPROTS     eProt;
  U8            nTimerIdx;
  ...
  uLocalTimer += ATMELSAM4LWIP_EXEC_RATE / TASK_TIME_MSECS( 1 );
