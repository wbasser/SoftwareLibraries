/******************************************************************************
 * @file AtmelSAM7LwipHandler_prm.h
 *
...
#ifndef _ATMELSAM7LWIPHANDLER_PRM_H
#define _ATMELSAM7LWIPHANDLER_PRM_H


/// define the host timer function
#define ATMELSAM7LWIP_HOST_FUNCTION( )   

/**@} EOF AtmelSAM7LwipHandler_prm.h */

#endif  // _ATMELSAM7LWIPHANDLER_PRM_H